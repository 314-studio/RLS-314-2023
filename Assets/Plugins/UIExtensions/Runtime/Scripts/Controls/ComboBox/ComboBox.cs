    ...
    public class ComboBox : MonoBehaviour
    {
        ...
        private bool Initialize()
        {
            ...
            catch (System.NullReferenceException ex)
            {
                ...
                DebugTool.Error("Something is setup incorrectly with the dropdownlist component causing a Null Reference Exception");
                success = false;
            }
        ...
        {
            //DebugTool.Log("item " + item + " clicked");
            Text = item;
        ...
        public void OnValueChanged(string currText)
        {
            Text = currText;
            RedrawPanel();
            //DebugTool.Log("value changed to: " + currText);
