...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableList : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                DebugTool.Error("You need to have a child LayoutGroup content set for the list: " + name, gameObject);
                return;
            }
            ...
            {
                DebugTool.Error("You need to have a Graphic control (such as an Image) for the list [" + name + "] to be droppable", gameObject);
                return;
            }
        ...
        {
            DebugTool.Log("Event Received");
            DebugTool.Log("Hello World, is my item a clone? [" + item.IsAClone + "]");
        }
