...
namespace RLSGame
{
	...
	public partial class Config
	{
		...
		static tabtoy.DeserializeHandler<GoodConfigDefine> _GoodConfigDefineDeserializeHandler;
		static tabtoy.DeserializeHandler<GoodConfigDefine> GoodConfigDefineDeserializeHandler
		{
			get
			{
				if (_GoodConfigDefineDeserializeHandler == null )
				{
					_GoodConfigDefineDeserializeHandler = new tabtoy.DeserializeHandler<GoodConfigDefine>(Deserialize);
				}

				return _GoodConfigDefineDeserializeHandler;
			}
		}
		public static void Deserialize( GoodConfigDefine ins, tabtoy.DataReader reader )
		{
		...
		static tabtoy.DeserializeHandler<LanguageDataDefine> _LanguageDataDefineDeserializeHandler;
		static tabtoy.DeserializeHandler<LanguageDataDefine> LanguageDataDefineDeserializeHandler
		{
			get
			{
				if (_LanguageDataDefineDeserializeHandler == null )
				{
					_LanguageDataDefineDeserializeHandler = new tabtoy.DeserializeHandler<LanguageDataDefine>(Deserialize);
				}

				return _LanguageDataDefineDeserializeHandler;
			}
		}
		public static void Deserialize( LanguageDataDefine ins, tabtoy.DataReader reader )
		{
		...
		static tabtoy.DeserializeHandler<TowerDefine> _TowerDefineDeserializeHandler;
		static tabtoy.DeserializeHandler<TowerDefine> TowerDefineDeserializeHandler
		{
			get
			{
				if (_TowerDefineDeserializeHandler == null )
				{
					_TowerDefineDeserializeHandler = new tabtoy.DeserializeHandler<TowerDefine>(Deserialize);
				}

				return _TowerDefineDeserializeHandler;
			}
		}
		public static void Deserialize( TowerDefine ins, tabtoy.DataReader reader )
		{
